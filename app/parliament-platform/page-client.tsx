  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <PageHeader
        ...
        subtitle={language === "bn" ? "শিক্ষা নীতি গঠনে নাগরিকদের কণ্ঠস্বর" : "Giving citizens a voice in shaping education policy"}
        eyebrow={language === "bn" ? "নাগরিক সংলাপ" : "Civic Dialogue"}
        breadcrumbs={[{ label: language === "bn" ? "কর্মসূচি" : "Programs" }, { label: t(language, "parliament") as string }]}
      />
      ...
      <section className="py-14 md:py-16 bg-white dark:bg-gray-950">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <p className="text-xl text-slate-600 dark:text-slate-300 leading-relaxed">
            {t(language, "parlIntro") as string}
          </p>
        </div>
      </section>
        ...
        <section className="py-20 bg-gray-50 dark:bg-gray-800 section-xl">
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-400 dark:text-gray-500 mb-2">
              {t(language, "parlEmptyTitle") as string}
            </h2>
            <p className="text-gray-400 dark:text-gray-500">
              {t(language, "parlEmptyDesc") as string}
            </p>
          </div>
        </section>
      : <>
          {/* {t(language, "parlFeatured") as string} */}
          {featured.length > 0 && (
            <section className="py-16 bg-gradient-to-br from-teal-600 to-blue-600 text-white section-xl">
                    ...
                    >
                      ...
                      <div className="p-8">
                        ...
                        {item.externalLink && (
                          ...
                          >
                            {t(language, "parlViewDetails") as string} <ExternalLink className="w-4 h-4" />
                          </a>
                        )}
                      </div>
                    </div>
          ...
          {regular.length > 0 && (
            <section className="py-16 bg-gray-50 dark:bg-gray-800 section-xl">
              <div className="max-w-7xl mx-auto px-6">
                <h2 className="text-3xl font-bold text-center mb-12 text-gray-900 dark:text-white">
                  {t(language, "parlSessions") as string}
                </h2>
                            ...
                            <div className="flex-1">
                              ...
                              <div className="flex items-center gap-4">
                                {item.content && (
                                  <details className="group">
                                    <summary className="text-teal-600 dark:text-teal-400 font-semibold cursor-pointer hover:underline text-sm">
                                      {t(language, "parlReadMore") as string}
                                    </summary>
                                ...
                                {item.externalLink && (
                                  ...
                                  >
                                    {t(language, "parlViewDetails") as string}{" "}
      ...
      <CTASection
        titleEn="Claim your seat in the civic parliament"
        titleBn="নাগরিক সংসদে আপনার আসন নিন"
        descEn="Debate, deliberate and design education policy with citizens across Bangladesh."
        descBn="সারা বাংলাদেশের নাগরিকদের সাথে শিক্ষা নীতি নিয়ে বিতর্ক ও পরিকল্পনা করুন।"
      />

      <RelatedPrograms current="/parliament-platform" />
