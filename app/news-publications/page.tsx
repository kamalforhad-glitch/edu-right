...
import { Newspaper, FileText, Bell, ExternalLink } from "lucide-react";
...
export default function NewsPublicationsPage() {
  ...
  const coverageItems = items.filter((i) => i.category === "Media Coverage");
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <PageHeader
        ...
        subtitle="Latest updates, research, and insights on education policy"
      />
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-800 hidden">
        <div className="max-w-7xl mx-auto px-6">
      ...
      <section className="py-16 bg-teal-600 dark:bg-teal-800 text-white hidden">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <Bell className="w-16 h-16 mx-auto mb-6" />
          <h2 className="text-3xl font-bold mb-4">
            Stay Informed with ERP Insights
          </h2>
